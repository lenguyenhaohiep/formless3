...
mainApp.controller("FunctionCtr", function($scope, $compile, sharedData, rdfa, schema) {
        ...
        try {
            ...
            if ($scope.keys.private_key != "" && $scope.keys.passphrase != "") {
                ...
                // if sign a current form
                    ...
                    //get the bogy
                    var bodyNode = document.getElementById("export").cloneNode(true);
                    cleanHTML(bodyNode);
     ...
     */
    $scope.getDoc = function(signed, html, body, id) {
    ...
    $scope.fill2 = function(){
        sharedData.parseForm(document.documentElement.innerHTML);
        $scope.fill();
        setTimeout( function () {
