...
var COMPONENT_TEXT = "<input data-oid='{{item.id}}' type='text' value='{{item.value}}' property='{{item.semantic.prefix}}{{item.semantic.property}}' content='{{item.value}}' class='form-control' ng-model='item.value' /><div class='input-validation'></div>";
var COMPONENT_NUMBER = "<input data-oid='{{item.id}}' type='number' value='{{item.value}}' property='{{item.semantic.prefix}}{{item.semantic.property}}' content='{{item.value}}' class='form-control' ng-model='item.value'  /><div class='input-validation'></div>";
var COMPONENT_DATE = "<input data-oid='{{item.id}}' type='date' value='{{item.value}}' property='{{item.semantic.prefix}}{{item.semantic.property}}' content='{{item.value}}' class='form-control' ng-model='item.value' /><div class='input-validation'></div>";
var COMPONENT_EMAIL = "<input data-oid='{{item.id}}' type='email' value='{{item.value}}' property='{{item.semantic.prefix}}{{item.semantic.property}}' content='{{item.value}}' class='form-control' ng-model='item.value' /><div class='input-validation'></div>";
var COMPONENT_TEXTAREA = "<textarea data-oid='{{item.id}}' rows='3' property='{{item.semantic.prefix}}{{item.semantic.property}}' content='{{item.value}}' class='form-control' ng-model='item.value' />{{item.value}}</textarea>";
...
var COMPONENT_SELECT = "<select data-oid='{{item.id}}' class='form-control' property='{{item.semantic.prefix}}{{item.semantic.property}}' content='{{item.value.label}}' ng-model='item.value' ng-options='option.label for option in item.field_options' ></select>";
var COMPONENT_SIGNATURE = "<input data-oid='{{item.id}}' class= 'fileupload' fileimage type-mode=1 ng-model='item.value' data-tempproperty='{{item.semantic.prefix}}{{item.semantic.property}}' type='file' accept='image/*' /><div ng-repeat-start='img in item.value' class='image-line'><span>{{img.name}}</span><img alt='' property='{{item.semantic.prefix}}{{item.semantic.property}}' src='{{img.src}}' title='{{img.name}}'><button ng-click='$parent.$parent.deleteImage(item,img)'>Remove</button></div><br ng-repeat-end />";
var COMPONENT_ATTACH = "<input data-oid='{{item.id}}' class= 'fileupload' fileimage type-mode=2 ng-model='item.value' data-tempproperty='{{item.semantic.prefix}}{{item.semantic.property}}' type='file' multiple accept='image/*' /><div ng-repeat-start='img in item.value' class='image-line'><span>{{img.name}}</span><img alt='' property='{{item.semantic.prefix}}{{item.semantic.property}}' src='{{img.src}}' title='{{img.name}}' ><button ng-click='$parent.$parent.deleteImage(item,img)'>Remove</button></div><br ng-repeat-end />";
